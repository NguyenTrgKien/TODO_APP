    ...
    >
      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div>
            <label className="block mb-1 text-gray-500" htmlFor="description">
              Mô tả
            </label>
            <textarea
              rows={3}
              ...
              className="w-full rounded-md border border-gray-300 focus:border-cyan-400 p-5"
              onChange={handleChangeInput}
            />
          </div>
          <div className="flex items-center gap-5">
            ...
            <div className="w-full">
              <label className="block mb-1 text-gray-500" htmlFor="priority">
                Độ ưu tiên *
              </label>
              <select
                name="priority"
          ...
          <div>
            <label className="block mb-1 text-gray-500" htmlFor="deadline">
              Thời hạn *
            </label>
            <input
              type="date"
              ...
              value={data.deadline}
              className="w-full h-[4.2rem] rounded-md border border-gray-300 focus:border-cyan-400 p-5"
              onChange={handleChangeInput}
            />
          </div>
          <div className="flex items-center gap-5 justify-end">
            <button
              className="px-5 py-3 rounded-md bg-gray-200 hover:bg-gray-300 transition-colors duration-300"
              onClick={onClose}
            >
              Hủy
            </button>
